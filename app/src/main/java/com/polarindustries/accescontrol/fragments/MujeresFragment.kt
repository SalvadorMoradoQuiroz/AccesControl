 ...
 * Use the [MujeresFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MujeresFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_mujeres, container, false)
        ...
        val legendLayout: FrameLayout = root.findViewById(R.id.legendLayout2)
        val chart = root.findViewById<com.faskn.lib.ClickablePieChart>(R.id.chart3)
    ...
    companion object {
         ...
         * @return A new instance of fragment MujeresFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MujeresFragment().apply {
